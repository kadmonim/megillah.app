// Auto-generated by scripts/fetch-translations.cjs
// Source: Sefaria — The Holy Scriptures: A New Translation (JPS 1917)
export const translationsEn: Record<string, string> = {
  "1:1": "NOW IT came to pass in the days of Ahasuerus—this is Ahasuerus who reigned, from India to Ethiopia, over a hundred and seven and twenty provinces—",
  ...
  "9:18": "But the Jews that were in Shushan assembled together on the thirteenth day thereof, and on the fourteenth thereof; and on the fifteenth day of the same they rested, and made it a day of feasting and gladness and they ate.",
  ...
  "9:25": "but when ashe came before the king, he commanded by letters that his wicked device, which he had devised against the Jews, should return upon his own head; and that he and his sons should be hanged on the gallows.",
